...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_FUNCTION = 5,                 /* T_FUNCTION  */
  ...
  YYSYMBOL_T_NEWLINE = 12,                 /* T_NEWLINE  */
  YYSYMBOL_T_QUIT = 13,                    /* T_QUIT  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_calculation = 15,               /* calculation  */
  YYSYMBOL_line = 16,                      /* line  */
  YYSYMBOL_function_name = 17,             /* function_name  */
...
static const yytype_uint8 yyrline[] =
{
     ...
     111,   119,   129,   130,   131,   132,   133,   134,   135,   136,
...
static const char *const yytname[] =
{
  ...
  "T_FUNCTION", "T_PLUS", "T_MINUS", "T_MULTIPLY", "T_DIVIDE", "T_LEFT",
  "T_RIGHT", "T_NEWLINE", "T_QUIT", "$accept", "calculation", "line",
  "function_name", "mixed_expression", "expression", YY_NULLPTR
};
...
{
      -7,    32,    -7,    -7,    -7,    -7,    -2,    -7,    -5,    -7,
      28,    -3,    40,    47,    53,    -7,    -2,    -7,    -2,    -2,
      -2,    -2,    -7,    -2,    -2,    -2,    -2,    -7,    -7,    -7,
      59,    65,    25,    42,    25,    42,    -7,    -7,    -7,    -7,
      25,    42,    25,    42,    -7,    -7,    -7,    -7,    -7,    -7
};
...
{
       2,     0,     1,    27,    12,     9,     0,     4,     0,     3,
       0,     0,     0,     0,     0,     8,     0,     7,     0,     0,
       0,     0,     5,     0,     0,     0,     0,     6,    17,    31,
       0,     0,    13,    22,    14,    23,    15,    24,    16,    25,
      18,    28,    19,    29,    20,    30,    21,    26,    11,    10
};
...
{
      13,     3,     4,    18,    19,    20,    21,    15,     6,    22,
      30,    14,    32,    34,    36,    38,     0,    40,    42,    44,
      46,    31,     0,    33,    35,    37,    39,     0,    41,    43,
      45,    47,     2,    20,    21,     3,     4,     5,    16,     0,
      17,     0,     6,     0,     7,     8,    23,    24,    25,    26,
      25,    26,    27,    18,    19,    20,    21,     0,    28,    23,
      24,    25,    26,     0,    29,    18,    19,    20,    21,     0,
      48,    23,    24,    25,    26,     0,    49
};

static const yytype_int8 yycheck[] =
{
       6,     3,     4,     6,     7,     8,     9,    12,    10,    12,
      16,     6,    18,    19,    20,    21,    -1,    23,    24,    25,
      26,    16,    -1,    18,    19,    20,    21,    -1,    23,    24,
      25,    26,     0,     8,     9,     3,     4,     5,    10,    -1,
      12,    -1,    10,    -1,    12,    13,     6,     7,     8,     9,
       8,     9,    12,     6,     7,     8,     9,    -1,    11,     6,
...
static const yytype_int8 yystos[] =
{
      ...
      17,    18,    19,    18,    19,    12,    10,    12,     6,     7,
       8,     9,    12,     6,     7,     8,     9,    12,    11,    11,
      18,    19,    18,    19,    18,    19,    18,    19,    18,    19,
      18,    19,    18,    19,    18,    19,    18,    19,    11,    11
};
...
#line 1183 "calc.tab.c"
  ...
  case 7: /* line: function_name T_NEWLINE  */
#line 106 "calc.y"
                                  { printf("\tResult: %s\n", (yyvsp[-1].fname)); }
...
#line 1195 "calc.tab.c"
  ...
  case 10: /* function_name: function_name T_LEFT expression T_RIGHT  */
#line 111 "calc.y"
                                                 { 
		char * functionName = (yyvsp[-3].fname);
...
#line 1208 "calc.tab.c"
  ...
  case 11: /* function_name: function_name T_LEFT mixed_expression T_RIGHT  */
#line 119 "calc.y"
                                                       { 
		char * functionName = (yyvsp[-3].fname);
...
#line 1221 "calc.tab.c"
  ...
  case 12: /* mixed_expression: T_FLOAT  */
#line 129 "calc.y"
...
#line 1311 "calc.tab.c"
  ...
  case 27: /* expression: T_INT  */
#line 146 "calc.y"
                                                { (yyval.ival) = (yyvsp[0].ival); }
#line 1317 "calc.tab.c"
    break;

  case 28: /* expression: expression T_PLUS expression  */
#line 147 "calc.y"
                                        { (yyval.ival) = (yyvsp[-2].ival) + (yyvsp[0].ival); }
#line 1323 "calc.tab.c"
    break;

  case 29: /* expression: expression T_MINUS expression  */
#line 148 "calc.y"
                                        { (yyval.ival) = (yyvsp[-2].ival) - (yyvsp[0].ival); }
#line 1329 "calc.tab.c"
    break;

  case 30: /* expression: expression T_MULTIPLY expression  */
#line 149 "calc.y"
                                                { (yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival); }
#line 1335 "calc.tab.c"
    break;

  case 31: /* expression: T_LEFT expression T_RIGHT  */
#line 150 "calc.y"
