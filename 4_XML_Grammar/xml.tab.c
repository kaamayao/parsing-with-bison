...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_QUIT = 4,                     /* T_QUIT  */
  YYSYMBOL_ident = 5,                      /* ident  */
  YYSYMBOL_A = 6,                          /* A  */
  YYSYMBOL_B = 7,                          /* B  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_start_point = 9,                /* start_point  */
  YYSYMBOL_L = 10,                         /* L  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_NEWLINE", "T_QUIT",
  "ident", "A", "B", "$accept", "start_point", "L", "open", "close", "val", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* start_point: start_point L T_NEWLINE  */
#line 58 "xml.y"
                                       {
	validateSyntax();
}
#line 1107 "xml.tab.c"
  ...
  case 4: /* L: open L close  */
#line 62 "xml.y"
                 { 
		strcpy(open[indexOpen], (yyvsp[-2].name));
		strcpy(close[indexClose], (yyvsp[0].name));
		indexOpen++; 
		indexClose++; 
